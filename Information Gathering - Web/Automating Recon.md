...
```JavaScript
Nathan2112@htb[/htb]$ git clone https://github.com/thewhiteh4t/FinalRecon.git
Nathan2112@htb[/htb]$ cd FinalRecon
Nathan2112@htb[/htb]$ pip3 install -r requirements.txt
Nathan2112@htb[/htb]$ chmod +x ./finalrecon.py
Nathan2112@htb[/htb]$ ./finalrecon.py --help
...
```JavaScript
finalrecon --headers --whois --url http://<domain>
```
```JavaScript
Nathan2112@htb[/htb]$ ./finalrecon.py --headers --whois --url http://inlanefreight.com
