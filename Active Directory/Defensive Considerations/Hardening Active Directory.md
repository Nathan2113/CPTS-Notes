...
- enforcing security best practices will prevent easy wins
...
- used to restrict what members of this privileged group can do in the domain
```JavaScript
...
Caveat - Protected users can cause issues with authentication, which can easily result in account lockouts
...
## Technology
review AD for legacy misconfigurations and new and emerging threats
