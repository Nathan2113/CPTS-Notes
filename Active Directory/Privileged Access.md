...
```
![image 202.png](../assets/Privileged%20Access/image%20202.png)
  
### Bloodhound
does the domain users group have CanRDP?
![image 1 149.png](../assets/Privileged%20Access/image%201%20149.png)
  
if we have a user, do they have RDP privileges?
- under node info → execution rights
![image 2 133.png](../assets/Privileged%20Access/image%202%20133.png)
...
```
![image 3 119.png](../assets/Privileged%20Access/image%203%20119.png)
...
```
![image 4 108.png](../assets/Privileged%20Access/image%204%20108.png)
  
Can add the Cypher Quiery as a Custom Query to always have access to it
![image 5 105.png](../assets/Privileged%20Access/image%205%20105.png)
...
```
![image 6 93.png](../assets/Privileged%20Access/image%206%2093.png)
...
```
![image 7 90.png](../assets/Privileged%20Access/image%207%2090.png)
